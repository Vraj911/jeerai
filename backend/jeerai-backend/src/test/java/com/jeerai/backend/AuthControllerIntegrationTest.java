...
class AuthControllerIntegrationTest {
    ...
    @Test
    void signupReturnsJwtAndUser() throws Exception {
        mockMvc.perform(post("/auth/signup")
                ...
                .andExpect(jsonPath("$.user.email").value("signup-user@example.com"));
    }

    @Test
    void loginWorksForSeededMockUser() throws Exception {
