...
/**
 * Supports Chrome/Edge "Private Network Access" preflight when an https page calls a loopback/private
 * address (e.g., https://jeerai.netlify.app -> http://localhost:5000).
 */
